00007C00  E90E00            jmp word 0x7c11
...
00007C1E  31D2              xor dx,dx
00007C20  89D7              mov di,dx
00007C22  B90E00            mov cx,0xe
00007C25  8A04              mov al,[si]
00007C27  268805            mov [es:di],al
00007C2A  46                inc si
00007C2B  47                inc di
00007C2C  26C60507          mov byte [es:di],0x7
00007C30  47                inc di
00007C31  E2F2              loop 0x7c25
00007C33  31D2              xor dx,dx
00007C35  B80000            mov ax,0x0
00007C38  BB0100            mov bx,0x1
00007C3B  01DA              add dx,bx
00007C3D  43                inc bx
00007C3E  83FB64            cmp bx,byte +0x64
00007C41  7EF8              jng 0x7c3b
00007C43  31C9              xor cx,cx
00007C45  8ED1              mov ss,cx
00007C47  BC0000            mov sp,0x0
00007C4A  BB0A00            mov bx,0xa
00007C4D  89D0              mov ax,dx
00007C4F  41                inc cx
00007C50  31D2              xor dx,dx
00007C52  F7F3              div bx
00007C54  80CA30            or dl,0x30
00007C57  52                push dx
00007C58  83F800            cmp ax,byte +0x0
00007C5B  75F2              jnz 0x7c4f
00007C5D  5A                pop dx
00007C5E  268815            mov [es:di],dl
00007C61  47                inc di
00007C62  26C60507          mov byte [es:di],0x7
00007C66  47                inc di
00007C67  49                dec cx
00007C68  E2F3              loop 0x7c5d
00007C6A  E9FDFF            jmp word 0x7c6a
...
00007C62  26C60507          mov byte [es:di],0x7
00007C66  47                inc di
00007C67  E2F4              loop 0x7c5d
00007C69  E9FDFF            jmp word 0x7c69
